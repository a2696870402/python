...
# 这里操作后变成14x14x64
x2 = tf.nn.max_pool(x1, ksize=[1, 3, 3, 1], strides=[1, 1, 1, 1], padding='SAME')
x2 = convolutional_block(X_input=x1, kernel_size=3, in_filter=64,  out_filters=[64, 64, 256], stage=2,
                         block='a', stride=1)
...
print("cuiwei")
for i in range(3000):
    batch = minst.train.next_batch(10)
    if i%100 == 0:
